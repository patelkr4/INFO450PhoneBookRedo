...

{
	...
	cout << endl << "Home Number in format of (xxx-xxx-xxxx): ";

	cin >> contact.number1;

	cout << endl << "Mobile Number in format of (xxx-xxx-xxxx): ";
...

{
	...
	if (showall) {
		...
		cout << endl << "Home Number in format of (xxx-xxx-xxxx): " << contact.number1;

		cout << endl << "Mobile Number in format of (xxx-xxx-xxxx): " << contact.number2;
...

{
	...
	else if (!strcmp(contact.number1, searchThis)) { return true; }

	else if (!strcmp(contact.number2, searchThis)) { return true; }
